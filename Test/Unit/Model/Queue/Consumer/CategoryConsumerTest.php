<?php
/**
 * ClusterifyAI ChatBot category consumer unit test
 *
 ...
 *
 * Tests the category queue consumer execution and error resilience.
 */
class CategoryConsumerTest extends TestCase
{
    /**
    ...
    public function testProcessExitsWhenCanSyncReturnsFalse(): void
    {
        ...
        $messageStub->method('getEntityType')->willReturn('category');
        $messageStub->method('getEntityId')->willReturn(4);
