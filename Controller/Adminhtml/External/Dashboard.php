<?php
/**
 * ClusterifyAI ChatBot external dashboard redirect action
 *
 ...
 * Class Dashboard
 *
 * Redirects admin user to the external Clusterify.AI Cloud Dashboard.
 */
class Dashboard extends Action implements HttpGetActionInterface
{
    public const ADMIN_RESOURCE = 'ClusterifyAI_ChatBot::status';
    public const TARGET_URL = 'https://dashboard.clusterify.ai';
